...
그렇게 탄생한 초기 모델 `gf2hotkey`는 점차 기능을 넓혀, 현재는 어떤 게임이나 프로그램에도 대응할 수 있는 `JKGameHotKey`로 진화했습니다.
...
* **마스터 인덱스 시스템**: `JK_AHK_SheetNameKey.csv`가 모든 게임의 프로세스명과 데이터 경로를 중앙 제어합니다.
